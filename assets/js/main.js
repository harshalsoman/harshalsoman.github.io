...
document.addEventListener("DOMContentLoaded", function() {
    const titles = ["Data Scientist", "Software Engineer", "Machine Learning Engineer"];
    let currentIndex = 0;
    ...
    updateTitle();
    setInterval(updateTitle, 1300); // Change title every 3.5 seconds to include fade time
});